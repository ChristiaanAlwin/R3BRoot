...
#pragma link C++ class R3Bveto_segPoint+;
#pragma link C++ class R3BNeutronTrak_seg+;
#pragma link C++ class R3Bveto_segDigi+;
#pragma link C++ class R3Bveto_segFirstHits+;
#pragma link C++ class R3Bveto_segHit+;
#pragma link C++ class R3BPaddleCrystalHt_seg+;
#pragma link C++ class R3BNveto_segMappedData+;
#pragma link C++ class R3BNveto_segPoint+;
#pragma link C++ class R3BNveto_segDigi+;
#pragma link C++ class R3BNveto_segCluster+;
#pragma link C++ class R3BNveto_segNeutron+;
#pragma link C++ class R3BPaddle_segTamexMappedData+;
#pragma link C++ class R3BNveto_segUnpackData+;
#pragma link C++ class R3BNveto_segCalData+;
