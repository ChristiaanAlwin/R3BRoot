...
void R3BNveto_segMappedHist::Exec(Option_t* option)
{
    ...
    if (fveto_segMappedData)
    {
        ...
        for (Int_t i = 0; i < nveto_segMapped; i++)
        {
            ...
            fh_veto_seg_mapped_is17->Fill(hitmapped->Is17());
            if (!hitmapped->Is17())
            {
...
void R3BNveto_segMappedHist::CreateHistos()
{
    ...
    fh_veto_seg_mapped_is17 = new TH1F("h_veto_seg_mapped_is17", "Is 17", 4, -0.5, 3.5);
    ...
    run->AddObject(fh_veto_seg_mapped_is17);
