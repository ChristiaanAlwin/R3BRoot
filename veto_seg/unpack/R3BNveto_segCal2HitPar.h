...
#ifndef R3BNVETO_SEGCAL2HITPAR_H
#define R3BNVETO_SEGCAL2HITPAR_H

#include "FairTask.h"
#include "R3Bveto_segCosmic1Util.h"
...
class R3BNveto_segCal2HitPar : public FairTask
{

  public:
    R3BNveto_segCal2HitPar();
    R3BNveto_segCal2HitPar(const char* name, Int_t iVerbose = 1);
    virtual ~R3BNveto_segCal2HitPar();
  ...
  public:
    ClassDef(R3BNveto_segCal2HitPar, 0)
};
