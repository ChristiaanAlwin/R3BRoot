...
#ifndef R3BNVETO_SEGMAPPED2CAL_H
#define R3BNVETO_SEGMAPPED2CAL_H
...
/**
 * An analysis task to apply TCAL calibration for Nveto_seg.
 * This class reads Nveto_seg raw items with TDC values and
 * produces time items with time in [ns]. It requires TCAL
 * calibration parameter_seg, which are produced in a separate
 * analysis run containing R3BNveto_segMapped2CalPar task.
 * @author D. Kresan
 * @since September 7, 2015
 */
class R3BNveto_segMapped2Cal : public FairTask
{
  ...
  public:
     ...
     */
    R3BNveto_segMapped2Cal(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BNveto_segMapped2Cal();
    ...
    /**
     * Method for setting the number of Nveto_seg modules.
  ...
  public:
    ClassDef(R3BNveto_segMapped2Cal, 1)
};
