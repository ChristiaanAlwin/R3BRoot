...
void SetParameters()
{
  ...
  TObjString* Event_Generator = new TObjString("ascii");	// Decides which software is used to generate the primary particles.
								...
								// Default = "box"
  TObjString* Output_Name = new TObjString("1n1p");   	// Determines the name of the output files of the simulation. Replace the string
  ...
  Integers->SetBinContent(315,1);		// If this bin is set to unity, the trigger is calculated. Otherwise not. Default = 1
