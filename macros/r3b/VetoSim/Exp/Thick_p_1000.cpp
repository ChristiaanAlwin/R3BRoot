...
void SetParameters()
{
  ...
  Doubles->SetBinContent(129,0.4);		// VETO Scintillator bar thickness [cm].   Default:    1.2 (NeuLAND)
  ...
  Integers->SetBinContent(218,2212);     	// Particle ID code: particle species [int]. Default = 2112 (neutrons) NOTE: Check if the mass is added at the end of this file!
  ...
  TObjString* Event_Generator = new TObjString("ascii");	// Decides which software is used to generate the primary particles.
								...
								// Default = "box"
  TObjString* Output_Name = new TObjString("Thick_p_160");   	// Determines the name of the output files of the simulation. Replace the string
  ...
  Doubles->SetBinContent(134,0.1);		// VETO step size to increase the thickness of a single scintillator bar of the VETO [cm]. Default = 0.1
  Integers->SetBinContent(220,20);		// Total number of runs the simulation will be repeated after adapting a parameter. 4 means 4 runs in total [int]. Default = 1
  ...
  Doubles->SetBinContent(302,1000.0);		// VETO energy threshold [keV] Default = 160 NOTE: Also used by digitizer!!!
