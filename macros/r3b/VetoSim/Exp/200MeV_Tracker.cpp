...
void SetParameters()
{
  ...
  Doubles->SetBinContent(202,0.199);		// Lower Bound op particle total energy! [GeV] Default = 0.0
  Doubles->SetBinContent(203,0.201);		// Upper Bound op particle total energy! [GeV] Default = 1.0
  ...
  Doubles->SetBinContent(212,0.199);		// Lower Bound op particle total energy! [GeV] Default = 0.0
  Doubles->SetBinContent(213,0.201);		// Upper Bound op particle total energy! [GeV] Default = 1.0
  ...
  TObjString* Event_Generator = new TObjString("ascii");	// Decides which software is used to generate the primary particles.
								...
								// Default = "box"
  TObjString* Output_Name = new TObjString("200MeVTracker");   	// Determines the name of the output files of the simulation. Replace the string
