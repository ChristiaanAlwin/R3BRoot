...
void SetParameters()
{
  ...
  // ----------------------------------- TARGET:
  TObjString* Target_Material = new TObjString("Sn"); // Target Target_Material choice. Replace the string with one of the following options;
  ...
  // ----------------------------------- TOF wall:
  Doubles->SetBinContent(41,-400.0); 	// TOF wall global x position [cm]. Default: -417.359574
  Doubles->SetBinContent(42,0.0);		// TOF wall global y position [cm]. Default:    2.4
  Doubles->SetBinContent(43,600.0);	// TOF wall global z position [cm]. Default:  960.777114
  
  Doubles->SetBinContent(44,0.0);		// TOF wall rotation around x-axis [deg.] Default:   0.0
  Doubles->SetBinContent(45,-45.0);		// TOF wall rotation around y-axis [deg.] Default: -31.0
  ...
  // ----------------------------------- DCH:
  Doubles->SetBinContent(31,-5.0); 		// DCH global x position [cm]. Default:  0.0
  ...
  Doubles->SetBinContent(35,-12.0);		// DCH rotation around y-axis [deg.] Default:  0.0
  ...
  // ------------------------------------- NeuLAND:
  Doubles->SetBinContent(111,-643.05); 		// NeuLAND global x position [cm]. Default:  0.0
  Doubles->SetBinContent(112,0.0);		// NeuLAND global y position [cm]. Default:  0.0
  Doubles->SetBinContent(113,1113.8);		// NeuLAND global z position [cm]. Default:  1550.0
  
  Doubles->SetBinContent(114,0.0);		// NeuLAND rotation around x-axis [deg.] Default:  0.0
  Doubles->SetBinContent(115,-30.0);		// NeuLAND rotation around y-axis [deg.] Default:  0.0
  ...
  // ------------------------------------- VETO:
  Doubles->SetBinContent(121,-553.05);		// VETO global x position [cm]. Default:     0.0
  Doubles->SetBinContent(122,0.0);		// VETO global y position [cm]. Default:     0.0
  Doubles->SetBinContent(123,957.92);		// VETO global z position [cm]. Default:  1200.0
  
  Doubles->SetBinContent(124,-30.0);		// VETO rotation around x-axis [deg.] Default: 0.0
  ...
  Integers->SetBinContent(218,1000501240);     	// Particle ID code: particle species [int]. Default = 2112 (neutrons) NOTE: Check if the mass is added at the end of this file!
  Integers->SetBinContent(219,1); 		// Number of primary particles per event [int]. Default = 1
  Doubles->SetBinContent(202,0.299);		// Lower Bound op particle total energy! [GeV] Default = 0.0
  Doubles->SetBinContent(203,0.301);		// Upper Bound op particle total energy! [GeV] Default = 1.0
  Doubles->SetBinContent(204,0.0);		// Lower bound of angle with z-axis at which particles are emitted [deg.] Default = 0.0
  Doubles->SetBinContent(205,4.584e-3);	        // Upper bound of angle with z-axis at which particles are emitted [deg.] Default = 4.584 (80 mrad)
  ...
  Doubles->SetBinContent(210,-400.0);		// z-coordinate of location of particle gun [cm]. Default = -200.0
  ...
  Integers->SetBinContent(221,0);		// A second beam is only simulated if this bin is set equal to unity. Default = 0
  ...
  Doubles->SetBinContent(212,0.999);		// Lower Bound op particle total energy! [GeV] Default = 0.0
  Doubles->SetBinContent(213,1.001);		// Upper Bound op particle total energy! [GeV] Default = 1.0
  ...
  Integers->SetBinContent(201,1000000); 	// Number of events in a single run [int]. Default = 100
  ...
  TObjString* Event_Generator = new TObjString("ascii");	// Decides which software is used to generate the primary particles.
								...
								// Default = "box"
  TObjString* Output_Name = new TObjString("EOS");   	// Determines the name of the output files of the simulation. Replace the string
  ...
  Integers->SetBinContent(205,1); 		// 0 or 1: 1 switches on the magnetic field of GLAD, 0 switches it off. Default = 1
  Doubles->SetBinContent(201,5700.0);		// Magnetic field current [A]. Default = 4000.0 (for 1 GeV beams). 1920.0 works nice for 300 MeV beams.
  ...
  Integers->SetBinContent(248,0);               // NOTE: ASCII-generator only. Choice of how to generate the ASCII-file.
  ...
  Integers->SetBinContent(243,2);		// Choice for Geant4 physics list:
  ...
  Integers->SetBinContent(206,1); 		// 0 or 1: 1 allows to use the Target, 0 does not. Default = 1
  ...
  Integers->SetBinContent(212,1); 		// 0 or 1: 1 allows to use the TOF wall, 0 does not. Default = 1
  Integers->SetBinContent(213,0); 		// 0 or 1: 1 allows to use MFI, 0 does not. Default = 1
  Integers->SetBinContent(214,1); 		// 0 or 1: 1 allows to use DCH, 0 does not. Default = 1
  ...
  Integers->SetBinContent(253,0);               // 0 or 1: 1 allows to use the Dummy Vacuum chamber behind GLAD. Default = 0.
  ...
  Doubles->SetBinContent(303,870.0);		// z-location of front XY-plane for identification of primary particles [cm] Default = 600.0
  Doubles->SetBinContent(304,1300.0);		// z-location of back XY-plane for identification of primary particles [cm] Default = 1700.0
  ...
  Doubles->SetBinContent(307,-800.0);   	// x-location of YZ-plane at TOF side for identification of primary particles [cm] Default = -150.0
  Doubles->SetBinContent(308,-450.0);		// x-location of YZ-plane at other side for identification of primary particles [cm] Default = 150.0
  ...
  Integers->SetBinContent(309,11);              // Selects the VETO condition:
  ...
  Doubles->SetBinContent(342,200.0);            // Vertices with a TOF above this cut are VETOed by definition in the combined VETO condition. [ns]. Default = 200.0
  ...
  Doubles->SetBinContent(337,-402.0);              // X-coordinate of where the PROTONS came from (Tracker VETO condition) [cm]. Default = 0.0
  Doubles->SetBinContent(338,0.0);              // Y-coordinate of where the PROTONS came from (Tracker VETO condition) [cm]. Default = 0.0
  Doubles->SetBinContent(339,595.0);              // Z-coordinate of where the PROTONS came from (Tracker VETO condition) [cm]. Default = 0.0
  ...
  Doubles->SetBinContent(343,5.0);              // TimeCut increase per step [ns]. Default = 5.0
  ...
  Doubles->SetBinContent(402,100.0);		// Emax in TOFvsEdep plots. [MeV] Default = 100.0
  Doubles->SetBinContent(403,0.0);		// TOF min. value in TOFvsEdep plots. [ns] Default = -50.0;
  Doubles->SetBinContent(404,100.0);		// TOF max. value in TOFvsEdep plots. [ns] Default = 200.0;
  ...
  Integers->SetBinContent(412,1);               // Number of neutrons that you want to detect. Is used in counting good events. Default = 4.
