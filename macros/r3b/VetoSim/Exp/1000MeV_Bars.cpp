...
void SetParameters()
{
  ...
  TObjString* Event_Generator = new TObjString("ascii");	// Decides which software is used to generate the primary particles.
								...
								// Default = "box"
  TObjString* Output_Name = new TObjString("1000MeVCluster");   	// Determines the name of the output files of the simulation. Replace the string
  ...
  Integers->SetBinContent(309,3);              // Selects the VETO condition:
