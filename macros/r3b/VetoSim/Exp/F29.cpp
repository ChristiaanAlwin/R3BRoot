...
void SetParameters()
{
  ...
  Integers->SetBinContent(218,1000090290);     	// Particle ID code: particle species [int]. Default = 2112 (neutrons) NOTE: Check if the mass is added at the end of this file!
  Integers->SetBinContent(219,1); 		// Number of primary particles per event [int]. Default = 1
  Doubles->SetBinContent(202,0.999);		// Lower Bound op particle total energy! [GeV] Default = 0.0
  Doubles->SetBinContent(203,1.001);		// Upper Bound op particle total energy! [GeV] Default = 1.0
  ...
  TObjString* Event_Generator = new TObjString("ascii");	// Decides which software is used to generate the primary particles.
								...
								// Default = "box"
  TObjString* Output_Name = new TObjString("F29");   	// Determines the name of the output files of the simulation. Replace the string
  ...
  Doubles->SetBinContent(201,13000.0);		// Magnetic field current [A]. Default = 4000.0 (for 1 GeV beams). 1920.0 works nice for 300 MeV beams.
  ...
  Integers->SetBinContent(211,1); 		// 0 or 1: 1 allows to use mTOF, 0 does not. Default = 1
  Integers->SetBinContent(212,1); 		// 0 or 1: 1 allows to use the TOF wall, 0 does not. Default = 1
  Integers->SetBinContent(213,1); 		// 0 or 1: 1 allows to use MFI, 0 does not. Default = 1
  ...
  Integers->SetBinContent(309,0);              // Selects the VETO condition:
  ...
  Doubles->SetBinContent(342,85.0);            // Vertices with a TOF above this cut are VETOed by definition in the combined VETO condition. [ns]. Default = 200.0
