...
void SetParameters()
{
  ...
  // ----------------------------------- mTOF:
  Doubles->SetBinContent(1,-125.824045); 	// mTOF global x position [cm]. Default: -155.824045
  ...
  Integers->SetBinContent(201,10000); 	// Number of events in a single run [int]. Default = 100
  ...
  Doubles->SetBinContent(201,2900.0);		// Magnetic field current [A]. Default = 4000.0 (for 1 GeV beams). 1920.0 works nice for 300 MeV beams.
  ...
  Integers->SetBinContent(310,0);               // If this bin is set to unity, all bars of NeuLAND are kept for the VETO condition. Default = 0
