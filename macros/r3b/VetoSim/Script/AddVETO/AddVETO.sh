...
echo ''
echo 'This script is tested on the R3Broot dev-branch of 22 August 2016.'
echo ''
echo '#################################################################################################'
echo ''
echo ''
...
######################################################################################################
# Add tin to the media-file:
cd ${VMCWORKDIR}
cd ./geometry/
cp ./media_r3b.geo ../Safe/media_r3b.geo
sed -i '9 a Tin                1  118.71  50.  7.26' ./media_r3b.geo
sed -i '10 a                   1  1  20.  .001' ./media_r3b.geo
sed -i '11 a                   0' ./media_r3b.geo
