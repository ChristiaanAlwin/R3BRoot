...
void Create_ASCII_File_Uniform()
{
  ...
  for (Int_t k = 0; k<nEvents; ++k)
  {
    ...
    for (Int_t n = 0; n<Num_Prim_Particle; ++n)
    {
      ...
      theta = TMath::Cos(TMath::Pi()*ThetaMin/180.0) - generator->Uniform(TMath::Cos(TMath::Pi()*ThetaMin/180.0) - TMath::Cos(TMath::Pi()*ThetaMax/180.0));
      theta = 180.0*TMath::ACos(theta)/TMath::Pi(); // [deg]
    ...
    if (Beam2_Exists==1)
    {
      ...
      {
	// generate theta and phi:
        theta = TMath::Cos(TMath::Pi()*ThetaMin2/180.0) - generator->Uniform(TMath::Cos(TMath::Pi()*ThetaMin2/180.0) - TMath::Cos(TMath::Pi()*ThetaMax2/180.0));
        theta = 180.0*TMath::ACos(theta)/TMath::Pi(); // [deg]
    ...
    if (Beam3_Exists==1)
    {
      ...
      {
	// generate theta and phi:
        theta = TMath::Cos(TMath::Pi()*ThetaMin3/180.0) - generator->Uniform(TMath::Cos(TMath::Pi()*ThetaMin3/180.0) - TMath::Cos(TMath::Pi()*ThetaMax3/180.0));
        theta = 180.0*TMath::ACos(theta)/TMath::Pi(); // [deg]
...
{
  TApplication* TheApp = new TApplication("Create_ASCII_File_Uniform",&argc,argv);
