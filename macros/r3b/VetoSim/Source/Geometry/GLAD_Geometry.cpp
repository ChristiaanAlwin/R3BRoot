...
void GLAD_Geometry()														// NOTE: Change by C. A. Douma!
{
  // =================================================================================
  ...
  Double_t X_position = Doubles->GetBinContent(101);
  Double_t Y_position = Doubles->GetBinContent(102);
  Double_t Z_position = Doubles->GetBinContent(103);
  
  Double_t Rotation_X = Doubles->GetBinContent(104);
  Double_t Rotation_Y = Doubles->GetBinContent(105);
  Double_t Rotation_Z = Doubles->GetBinContent(106);
  ...
  TString geoFileName = "../../Data/Geometry/GLAD.geo.root";									// NOTE: Change by C. A. Douma!
  // --------------------------------------------------------------------------
  ...
  t0->RotateX(Rotation_X);													// NOTE: Change by C. A. Douma!
  t0->RotateY(Rotation_Y);													// NOTE: Change by C. A. Douma!
  t0->RotateZ(Rotation_Z);													// NOTE: Change by C. A. Douma!
  t0->SetTranslation(X_position,Y_position,Z_position+DistanceToTarget+Correction);						// NOTE: Change by C. A. Douma!
  t0->RotateY(+7.3);
  t0->RotateZ(180.0);
