...
void MFI_Geometry()												// NOTE: Change by C. A. Douma!
{
  // =================================================================================
  ...
  Double_t X_position = Doubles->GetBinContent(71);
  Double_t Y_position = Doubles->GetBinContent(72);
  Double_t Z_position = Doubles->GetBinContent(73);
  
  Double_t Rotation_X = Doubles->GetBinContent(74);
  Double_t Rotation_Y = Doubles->GetBinContent(75);
  Double_t Rotation_Z = Doubles->GetBinContent(76);
  ...
  TString geoFileName = "../../Data/Geometry/MFI.geo.root";							// NOTE: Change by C. A. Douma!
  // --------------------------------------------------------------------------
