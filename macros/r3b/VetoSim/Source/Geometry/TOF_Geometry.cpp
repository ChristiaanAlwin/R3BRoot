...
void TOF_Geometry()													// NOTE: Change by C. A. Douma!
{
  // =================================================================================
  ...
  Double_t X_position = Doubles->GetBinContent(41);
  Double_t Y_position = Doubles->GetBinContent(42);
  Double_t Z_position = Doubles->GetBinContent(43);
  
  Double_t Rotation_X = Doubles->GetBinContent(44);
  Double_t Rotation_Y = Doubles->GetBinContent(45);
  Double_t Rotation_Z = Doubles->GetBinContent(46);
  ...
  TString geoFileName = "../../Data/Geometry/TOF.geo.root";								// NOTE: Change by C. A. Douma!
  // --------------------------------------------------------------------------
  ...
  dx = X_position; //Justyna											// NOTE: Change by C. A. Douma!
  dy = Y_position; //Justyna											// NOTE: Change by C. A. Douma!
  dz = Z_position; //Justyna											// NOTE: Change by C. A. Douma!
  ...
  gRot->RotateX(Rotation_X);		 									// NOTE: Change by C. A. Douma!
  gRot->RotateY(Rotation_Y);		 									// NOTE: Change by C. A. Douma!
  gRot->RotateZ(Rotation_Z);		 									// NOTE: Change by C. A. Douma!
