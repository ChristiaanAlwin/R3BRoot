...
Bool_t Leaf_Connect(Leaf_Structure* TheLeafs, Int_t const Counter_input, Int_t const Series)
{
   ...
   Bool_t total = MC&&CALIFA&&CALIFAhit&&STaRTrack&&STaRTrackh&&STaRTrackd&&STaRTrackt&&DCH&&TOF&&mTOF&&LP&&LFH&&VP&&VFH&&MFI&&PSP&&MCEvent&&Geo&&Ldigi&&Lclust&&Vdigi&&Vclust&&Ltrack&&VLP&&NLP&&DigiEvent;
   ...
   else
   {
     ...
     {
       cout << "GLAD detector exists. There are no corresponding leafs in the tree.\n";
     }
     else
     {
       cout << "GLAD detector does not exist.\n";
     }
